#lessens the code in invasion.py and all the functions are store at one place
...
def update_bullets(ai_settings,screen,stats,sb,ship,aliens,bullets):
    ...
    #getting rid of bullets disappeared
...
def get_number_rows(ai_settings,ship_height,alien_height):
    #determine the number of rows of alien that fits on screen
...
#move the code for updating the screen to a separate function to further simplify run_game():
...
def check_fleet_edges(ai_settings,aliens):
    #respond app if any aliens have reached an edge
...
def check_aliens_bottom(ai_settings,screen,stats,sb,ship,aliens,bullets):
    #check if ny aliens have reached the bottom of the screen
    screen_rect=screen.get_rect()
    for alien in aliens.sprites():
        if alien.rect.bottom>=screen_rect.bottom:
            #treat this same as ship_hit
...
def update_aliens(ai_settings,screen,stats,sb,ship,aliens,bullets):
    ...
    aliens.update() 
    #look for alien reaching bottom
